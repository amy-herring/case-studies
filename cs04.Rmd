...
- Final report: provide point and interval estimates of the % of votes won by each NC Congressional candidate, predicting the winner of each race. Provide point and interval estimates of the probability that the US House of Representatives remains under Republican control after the 2018 election. Include a description of your modeling and prediction strategy if any changes were made after the 10/31 report.
