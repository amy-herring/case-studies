...
## Initial Plot Continued
We want our colors to be more evenly distributed than they are based on the default. So, we'll create a histogram and set cut-points based on it.
```{r, fig.asp=0.5}
...
## Initial Plot Continued
Now, we can finially make our cuts.
```{r}
...
save(allCtryData, file = "data/allCtryData.RData")
