...
You will analyze data on survival in tens of thousands of individuals undergoing cardiac catheterization at Duke from 1985 to 2013. Relevant variables include the following.

- Year of catheterization procedure (proxy for standards of medical care at the time; for example, coronary stents were approved by the FDA in 1994, and the first drug-eluting stents were approved in 2003)
...
- Medical history including history of cerebrovascular disease (e.g., stroke), congestive heart failure, chronic obstructive pulmonary disease, diabetes, hypertension, myocardial infarction, or hyperlipidemia
...
- S3 gallop (while normal in people under 40 and in some athletes, in others it may indicate congestive heart failure)
- maximum percent stenosis of the left main coronary artery (stenosis is narrowing of the artery, usually the result of build-up of plaque; 0 is normal)
...
- number of diseased vessels (missing when no arteriograms were performed during catheterization, it represents the number of significantly blocked major vessels, ranging from 0-3)

## Case Study Data

The outcome of survival time is defined by two variables: a censoring indicator (DEATH=1 if death observed and DEATH=0 if censored before death) and the time to either death or the end of follow-up (DAYS2LKA).
