...
- Vital records data on North Carolina infant deaths of babies born 2011-2016
...
- make recommendations for where policymakers should invest resources to address infant mortality

##Case for Class: Infant Mortality

*Infant death* is defined as the death of a live-born infant during the first year of life. 
...
## Add here plotting information across NC States

Infant mortality data can be visualized in number of interesting ways. [A nice tutorial by Luke Tierney at Iowa](https://homepage.divms.uiowa.edu/~luke/classes/STAT4580/maps.html#focusing-on-iowa) covers a variety of options.

For illustration, we'll simulate data for North Carolina and plot it on the map.

## R code to link map and simulated data
...
```{r NCplot2a, eval=FALSE}
library(ggthemes); library(mapproj)
ggplot() +
