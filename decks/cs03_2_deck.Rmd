...
- Logistic regression in general was covered in deck 1, now go back and cover the odds ratio plus how to fit it from count data as binomial rather than bernoulli -- a first set of notes using German Rodriguez princeton notes
