...
In this document, we'll be recreating the visualization from the book using Tableau. We will be using the data we created earlier during the R visualization with the already merged data sets. If you haven't run the code from [case study 2 deck 1](cs02_1_deck.html), now is the time to do so, to ensure you have the data file ready for Tableau.
