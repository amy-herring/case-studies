...
pop_dta <- read_table("rawdata_2119.txt", col_names = c("X1", "country","X3", "X4", "pop"))
pop_dta <- pop_dta[,-c(1,3,4)] # remove blank columns
save(pop_dta, file="pop_data.RData")

IM_dta <- read_table("rawdata_2091.txt", col_names = c("X1", "country","X3", "X4", "infMort"))
IM_dta <- IM_dta[,-c(1,3,4)]
